...
import (
	...
	pb "github.com/LuisPabloG/202200129_LAB_SO1_2S2025_PROYECTO3/5_go_rabbit_writer/proto"
)
...
var (
	messagesPublished = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "rabbit_writer_messages_published_total",
	...
	messageLatency = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "rabbit_writer_message_latency_seconds",
			Help:    "Time taken to publish a message to RabbitMQ.",
...
// Tweet es la estructura que se enviará a RabbitMQ
type Tweet struct {
...
func (s *Server) SendTweet(ctx context.Context, req *pb.WeatherTweetRequest) (*pb.WeatherTweetResponse, error) {
	...
	// Configurar contexto con timeout para la publicación
	...
	log.Printf("Mensaje publicado en RabbitMQ: %s", string(jsonData))
...
func main() {
	...
	go func() {
		log.Println("Iniciando servidor de métricas en :9091")
	...
	go func() {
		log.Println("Iniciando servidor gRPC en :50052")
